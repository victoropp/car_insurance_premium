...
analysis_section = dbc.Container([
    ...
    # Row 1: Experience Impact and Vehicle Age
    dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardHeader("Driver Experience Impact"),
                dbc.CardBody([
                    dcc.Graph(
                        figure=individual_charts.create_experience_vs_premium(),
                        config={'displayModeBar': False},
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardHeader("Vehicle Age Analysis"),
                dbc.CardBody([
                    dcc.Graph(
                        figure=individual_charts.create_age_vs_premium(),
                        config={'displayModeBar': False},
    ...
    # Row 2: Accident History and Top Models
    dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardHeader("Accident History Impact"),
                dbc.CardBody([
                    dcc.Graph(
        ...
        dbc.Col([
            dbc.Card([
                dbc.CardHeader("Top Performing Models"),
                dbc.CardBody([
                    dcc.Graph(
    ...
    # Full Width: Complete Analysis View
    dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardHeader([
                    html.H5("Complete Detailed Analysis", className="mb-0")
                ]),
                dbc.CardBody([
                    dcc.Graph(
...
models_section = dbc.Container([
    ...
    # Full Width: Complete Model Comparison
    dbc.Row([
        dbc.Col([
            dbc.Card([
                dbc.CardHeader([
                    html.H5("Complete Model Performance Analysis", className="mb-0")
                ]),
                dbc.CardBody([
                    dcc.Graph(
